...
struct AppShellView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .onAppear {
                ...
                if !destination.isNative, destination.hasWebPage { parkedWebDestination = destination }
    ...
    private func navigate(_ next: StudioDestination) {
        ...
        // The hidden page only holds the session now; moving it with every
        // tab switch reloaded a web route each time for nothing.
