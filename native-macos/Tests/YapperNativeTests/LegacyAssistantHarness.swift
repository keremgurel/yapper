...
extension EditorSession {
    /// Compatibility harness for the original deterministic command tests.
    /// Interactive requests all use the catalog and context above.
    func runLegacyAssistant(instruction: String) async {
