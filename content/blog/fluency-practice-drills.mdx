...
- Then apply the routine inside a timed [Yapper random topic session](/training/random-topic-generator).
...
Then open [Yapper's random topic generator](/training/random-topic-generator) and do one timed prompt.
