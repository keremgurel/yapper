...
Open [Yapper's random topic generator](/training/random-topic-generator), set a one-minute timer, and do three rounds. Do not hunt for the perfect prompt. Do not rewrite the rules. Generate, speak, review one thing, repeat.
