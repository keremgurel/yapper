...
Yapper's [random topic generator](/training/random-topic-generator) is useful here because it removes topic selection from the rep. Pick a random prompt, speak for one minute, then check whether your pace stayed followable.
...
You can start with Yapper's [freestyle speaking practice](/freestyle-speech), [random topic generator](/training/random-topic-generator), or the [1-minute speech topics list](/blog/1-minute-speech-topics).
