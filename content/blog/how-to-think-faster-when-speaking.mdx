...
Use [Yapper's random topic generator](/training/random-topic-generator) for the prompts. If you want a list instead, start with [1-minute speech topics](/blog/1-minute-speech-topics) or [table topics questions](/blog/table-topics-questions).
