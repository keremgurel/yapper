...
- Start with one drill today inside [Yapper's random topic generator](/training/random-topic-generator), then repeat it for a week.
...
1. Open [Yapper](/training/random-topic-generator).
2. Generate a topic.
