      ...
      <div className="absolute inset-0 z-30 flex flex-col items-center justify-center overflow-hidden rounded-[inherit] bg-black/70 backdrop-blur-sm">
        <div className="flex w-full max-w-[340px] flex-col items-center gap-5 px-5">
          ...
          <div
            ...
            style={{ animation: "cs-pop 0.5s ease-out 0.15s both" }}
          >
            🎉
          </div>
          ...
          {/* Headline */}
          <h2
            className="font-display text-center text-[26px] font-bold tracking-tight text-white"
            style={{ animation: "cs-up 0.4s ease-out 0.3s both" }}
          >
            Nice work!
          </h2>
          ...
          {/* Topic */}
          <div
            className="w-full rounded-2xl border border-white/10 bg-white/8 px-5 py-4 text-center"
            style={{ animation: "cs-up 0.4s ease-out 0.4s both" }}
          >
          ...
          {/* Duration pill */}
          <div
            className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/8 px-4 py-2"
            style={{ animation: "cs-up 0.4s ease-out 0.5s both" }}
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
