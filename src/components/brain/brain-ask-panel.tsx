 ...
 */
export default function BrainAskPanel({
  onSave,
}: {
  ...
  return (
    <section className="sg-card flex flex-col gap-3 p-4 sm:p-5">
      <header>
      ...
      {suggestions.length > 0 && (
        <div className="space-y-2">
          {suggestions.map((suggestion) => (
            <article key={suggestion.title} className="sg-sunken space-y-2 p-3">
